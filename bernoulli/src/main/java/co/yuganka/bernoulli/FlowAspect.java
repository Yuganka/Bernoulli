...
import co.yuganka.bernoulli.annotation.PermissionRequestCode;
...
import co.yuganka.bernoulli.desilting.AskPermissionSet;
import co.yuganka.bernoulli.desilting.AskSettingSet;
...
public class FlowAspect {
    ...
    private static final String POINTCUT_METHOD_PERMISSION =
            "execution(@co.yuganka.bernoulli.annotation.RequiresPermission * *(..))";
    ...
    private static final String POINTCUT_METHOD_PERMISSION_REQUEST_CODE =
            "execution(@co.yuganka.bernoulli.annotation.PermissionRequestCode * *(..))";
    ...
    private static final String POINTCUT_METHOD_SETTING =
            "execution(@co.yuganka.bernoulli.annotation.RequiresSetting * *(..))";
 ...
 /*   *//**
    ...
    private static final String POINTCUT_METHOD_MULTIPLE_PERMISSION =
            "execution(@co.yuganka.bernoulli.annotation.repeatable.PermissionsRepeatable * *(..))";

    *//**
     * Defines a pointcut for the annotation RequiresSetting.
     *//*
    private static final String POINTCUT_METHOD_MULTIPLE_SETTING =
            "execution(@co.yuganka.bernoulli.annotation.repeatable.SettingsRepeatable * *(..))";
*/
    ...
    private static final String POINTCUT_METHOD_ATTACH_SCREEN =
            "execution(@co.yuganka.bernoulli.annotation.AttachScreen * *(..))";
